...
class ResolvedStatusCalculator(
    ...
    fun tryCalculateResolvedStatus(declaration: FirCallableMemberDeclaration<*>): FirResolvedDeclarationStatus {
        ...
        val designation = designationMapForLocalClasses[declaration] ?: run {
            val file = firProvider.getFirCallableContainerFile(symbol)
            ...
            (listOf(file) + outerClasses.filterNotNull().asReversed())
        }
